...
function Flow() {
  ...
  const appStyle = {
    '--app-bg': themeVars.appBg,
    '--app-text': themeVars.appText,
    '--toolbar-bg': theme === 'snowlight' ? '#f5f5f5' : '#2d3748',
    '--toolbar-border': theme === 'snowlight' ? '#ddd' : '#4a5568',
    '--toolbar-text': theme === 'snowlight' ? '#333' : '#e2e8f0',
    '--button-bg': theme === 'snowlight' ? '#007bff' : '#3182ce',
    '--button-hover': theme === 'snowlight' ? '#0056b3' : '#2c5282',
    '--dialog-bg': theme === 'snowlight' ? 'white' : '#2d3748',
    '--dialog-text': theme === 'snowlight' ? '#333' : '#e2e8f0',
    '--input-bg': theme === 'snowlight' ? 'white' : '#4a5568',
    '--input-border': theme === 'snowlight' ? '#ddd' : '#718096',
    '--input-text': theme === 'snowlight' ? '#333' : '#e2e8f0',
  ...
  return (
    <div className="App" style={appStyle} data-theme={theme}>
