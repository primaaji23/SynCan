                        ...
                        <table style={{ width: "100%", borderCollapse: "collapse", minWidth: 1000 }}>
                            <thead>
                                <tr>
                                    ...
                                    <th style={{ textAlign: "left", padding: "10px 8px", borderBottom: "1px solid var(--table-border)", color: "var(--text-2)", fontSize: 12, fontWeight: 900, textTransform: "uppercase", letterSpacing: "0.04em" }}>
                                        Notes
                                    </th>
